    ...
    _createClass(Input, [{
        ...
        value: function render() {
            ...
            var _context = this.context,
                formContext = _context.joiForm,
                joiFormGlobal = _context.joiFormGlobal;


            if (!formContext) return _react2.default.createElement("div", null);

            var options = this.__getFieldParams(this.props, formContext.schema[name], formContext.errors[name]);
            var fieldComponentCreator = joiFormGlobal.components[options.type];
...
Input.contextTypes = {
    joiForm: object,
    joiFormGlobal: _react.PropTypes.object
};
